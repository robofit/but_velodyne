...
public:
  ...
  int  length() const;
  inline int  hbins() const
  {
    return hbins_;
  }
  inline int  sbins() const
  {
    return sbins_;
  }
...
public:
  ...
  inline const cv::Mat& labels()   const
  {
    return labels_;
  }
  inline const cv::Mat& features() const
  {
    return features_;
  }
...
public:
  ...
  inline const HSVHistFeature& featureExtractor() const
  {
    return hsvftr_;
  }
  inline bool empty() const
  {
    return svm_.get_var_count() == 0;
  }
